var FullCalendar = function(e) {
    ...
    ge.FullCalendarVDom ? console.warn("FullCalendar VDOM already loaded") : ge.FullCalendarVDom = {
        ...
        flushToDom: function() {
            ...
            for (i.debounceRendering = function(e) {
                    t.push(e)
                }, L(v(me, {}), document.createElement("div")); t.length;) t.shift()();
    ...
    function nn(e, t, n) {
        ...
        return 1 === o && "short" === e.timeZoneName ? function(e) {
            ...
            return function(e, t, n, r, o) {
                var i = [];
                return "long" === o ? i.push(n) : "short" !== o && "narrow" !== o || i.push(t), "long" !== o && "short" !== o || i.push(" "), i.push(r.simpleNumberFormat.format(e)), "rtl" === r.options.direction && i.reverse(), i.join("")
            ...
            return function(r) {
                var a = r.marker;
                return function(e, t, n, r, o) {
                    return e = e.replace(Qt, ""), "short" === n.timeZoneName && (e = function(e, t) {
                        var n = !1;
                        return e = e.replace(en, (function() {
                            return n = !0, t
                        })), n || (e += " " + t), e
                    }(e, "UTC" === o.timeZone || null == t.timeZoneOffset ? "UTC" : jt(t.timeZoneOffset))), r.omitCommas && (e = e.replace($t, "").trim()), r.omitZeroMinute && (e = e.replace(":00", "")), !1 === r.meridiem ? e = e.replace(Kt, "").trim() : "narrow" === r.meridiem ? e = e.replace(Kt, (function(e, t) {
    ...
    function Nn(e, t, n, r, o) {
        ...
        if (u) return (c = An(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = {
            typeId: u.typeId,
            typeData: u.typeData,
            duration: u.duration
        }, {
        ...
        var c, d = function(e, t, n, r) {
            ...
            return null != e.end && (i = n.dateEnv.createMarkerMeta(e.end)), null == a && (a = null != t ? t : (!o || o.isTimeUnspecified) && (!i || i.isTimeUnspecified)), a && s && (s = lt(s)), i && (u = i.marker, a && (u = lt(u)), s && u <= s && (u = null)), u ? l = !0 : r || (l = n.options.forceEventDuration || !1, u = n.dateEnv.add(s, a ? n.options.defaultAllDayEventDuration : n.options.defaultTimedEventDuration)), {
                allDay: a,
                hasEnd: l,
                range: {
                    start: s,
    ...
    function Fn(e, t) {
        var n, r, o = [],
            i = t.start;
        for (e.sort(Bn), n = 0; n < e.length; n += 1)(r = e[n]).start > i && o.push({
            start: i,
            end: r.start
        }), r.end > i && (i = r.end);
    ...
    function Zn(e, t, n, r) {
        ...
        for (var c in i)
            for (var D = 0, C = Fn(i[c], n); D < C.length; D++) b = C[D], s.push({
                def: e.defs[c],
                ui: u[c],
                instance: null,
                range: b,
    ...
    function Qn(e, t) {
        var n = [];
        return t[""] && n.push(t[""]), t[e.defId] && n.push(t[e.defId]), n.push(e.ui), kn(n)
    }
    ...
    function dr(e, t, n) {
        var o = function(e, t) {
                var n = mn(e, cr),
                    ...
                    l = o.allDay;
                return null == l && (l = a && a.isTimeUnspecified && (!s || s.isTimeUnspecified)), r({
                    range: {
    ...
    function mr(e, t) {
        ...
        return r(i, (n = e, o = t.dateEnv, r(r({}, hr(n.range, o, n.allDay)), {
            allDay: n.allDay
        }))), i
    }
    ...
    function Er(e, t, n, r) {
        ...
        for (var l in e.instances) {
            var u = e.instances[l];
            s = i.defs[u.defId], i.instances[l] = br(u, s, o[u.defId], n, r)
        }
        return i
    }
    ...
    function Sr(e, t, n, o) {
        ...
        for (var s = 0, l = o.pluginHooks.eventDefMutationAppliers; s < l.length; s++)(0, l[s])(a, n, o);
    ...
    function br(e, t, n, o, i) {
        var a = i.dateEnv,
            ...
            u = r({}, e);
        return s && (u.range = Ln(u.range)), o.datesDelta && n.startEditable && (u.range = {
        ...
        }), u.range.end < u.range.start && (u.range.end = yr(t.allDay, u.range.start, i)), u
    }
    var Dr = function() {
            function e(e, t, n) {
    ...
    function wr(e, t, n) {
        var r;
        if (void 0 === n && (n = Rr(t)), "string" == typeof e ? r = {
                url: e
    ...
    var Tr = function() {
        ...
        kr = function() {
            ...
            return e.prototype.setProp = function(e, t) {
                var n, r;
                if (e in In) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead.");
                else if ("id" === e) t = Mn[e](t), this.mutate({
                    standardProps: {
                        publicId: t
                    }
                });
                else if (e in Mn) t = Mn[e](t), this.mutate({
    ...
    function po(e, t) {
        ...
        return lo() && "rtl" === n.direction ? u.scrollbarLeft = l : u.scrollbarRight = l, t && (u.paddingLeft = parseInt(n.paddingLeft, 10) || 0, u.paddingRight = parseInt(n.paddingRight, 10) || 0, u.paddingTop = parseInt(n.paddingTop, 10) || 0, u.paddingBottom = parseInt(n.paddingBottom, 10) || 0), u
    }
    ...
    if (Do.prototype.classes = {}, Do.prototype.iconClasses = {}, Do.prototype.baseIconClass = "", Do.prototype.iconOverridePrefix = "", "undefined" == typeof FullCalendarVDom) throw new Error("Please import the top-level fullcalendar lib before attempting to import a plugin.");
    ...
    var Oo = function(e) {
        ...
        }, t.addPropsEquality = Lo, t.addStateEquality = Uo, t.contextType = No, t
    }(Co);
    Oo.prototype.propEquality = {}, Oo.prototype.stateEquality = {};
    var Ao = function(e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
        return n(t, e), t.contextType = No, t
    }(Oo);
    ...
    }, Bo.prototype.baseIconClass = "fc-icon", Bo.prototype.iconClasses = {
        close: "fc-icon-x",
    ...
    }, Bo.prototype.iconOverrideOption = "buttonIcons", Bo.prototype.iconOverrideCustomButtonOption = "icon", Bo.prototype.iconOverridePrefix = "fc-icon-";
    var jo = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.rootElRef = _o(), t.handleRootEl = function(e) {
                    Wo(t.rootElRef, e), t.props.elRef && Wo(t.props.elRef, e)
                }, t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
    ...
    var Yo = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                return void 0 === t && (t = $o(e.defaultContent, e.hookProps)), null == t ? null : t
        ...
        Zo = function(e) {
            function t() {
                ...
                return t.handleRootEl = function(e) {
                    t.rootEl = e, t.props.elRef && Wo(t.props.elRef, e)
                }, t
            }
            return n(t, e), t.prototype.render = function() {
    ...
    function Xo() {
        var e, t, n = [];
        return function(r, o) {
            return t && wt(t, o) && r === e || (e = r, t = o, n = Ko(r, o)), n
        }
    }

    function Ko(e, t) {
        return "function" == typeof e && (e = e(t)), wn(e)
    }
            ...
            return function(e, t, n, o, i) {
                ...
                if (a && (s = function(e) {
                        var t = JSON.stringify(e),
                            n = ni[t];
                        return void 0 === n && (n = Nt(e), ni[t] = n), n
                    }(a))) {
                    var d = Vt(s);
    ...
    var ni = {},
        ri = function() {
            function e(e) {
                this.props = e, this.nowDate = _r(e.nowInput, e.dateEnv), this.initHiddenDays()
            }
            return e.prototype.buildPrev = function(e, t, n) {
                ...
                return r = this.buildValidRange(), r = this.trimHiddenDays(r), n && (u = e, e = null != (c = r).start && u < c.start ? c.start : null != c.end && u >= c.end ? new Date(c.end.valueOf() - 1) : u), o = this.buildCurrentRangeInfo(e, t), i = /^(year|month|week|day)$/.test(o.unit), a = this.buildRenderRange(this.trimHiddenDays(o.range), o.unit, i), s = a = this.trimHiddenDays(a), d.showNonCurrentDates || (s = zn(s, o.range)), s = zn(s = this.adjustActiveRange(s), r), l = Gn(o.range, r), {
                    validRange: r,
    ...
    var Ci = [Fo({
                    ...
                    var o = e.eventSource.meta,
                        i = function(e, t, n) {
                            var o, i, a, s, l = n.dateEnv,
                                u = n.options,
                                c = {};
                            return null == (o = e.startParam) && (o = u.startParam), null == (i = e.endParam) && (i = u.endParam), null == (a = e.timeZoneParam) && (a = u.timeZoneParam), s = "function" == typeof e.extraParams ? e.extraParams() : e.extraParams || {}, r(c, s), c[o] = l.formatIso(t.start), c[i] = l.formatIso(t.end), "local" !== l.timeZone && (c[a] = l.timeZone), c
                        }(o, e.range, e.context);
        ...
        Ri = function() {
            function e(e, t) {
                this.runTaskOption = e, this.drainedOption = t, this.queue = [], this.delayedRunner = new wi(this.drain.bind(this))
            }
    ...
    var Ti = function() {
        function e(e) {
            var t = this;
            this.computeOptionsData = qt(this._computeOptionsData), this.computeCurrentViewData = qt(this._computeCurrentViewData), this.organizeRawLocales = qt(Wr), this.buildLocale = qt(Vr), this.buildPluginHooks = function() {
                var e, t = [],
                    n = [];
                return function(o, i) {
            ...
            var s, l, u, c = (s = o.calendarOptions, l = o.dateEnv, null != (u = s.initialDate) ? l.createMarker(u) : _r(s.now, l)),
            ...
            for (var p = {
                ...
                }, f = 0, h = o.pluginHooks.contextInit; f < h.length; f++)(0, h[f])(p);
            ...
            Oi(g, p) && this.emitter.trigger("loading", !0), this.state = g, this.updateData(), this.actionRunner.resume()
        }
        return e.prototype.resetOptions = function(e, t) {
            ...
            }(d, e), u.dateProfileGenerator), "PREV" !== e.type && "NEXT" !== e.type && Yn(p.currentRange, d) || (d = p.currentRange.start);
                            ...
                            return function(e, t, n, r, o, i) {
                                if (t && n === t.latestFetchId) {
                                    var a = En(function(e, t, n) {
                                        ...
                                        return o && (e = di(e, o)), r && (e = di(e, r)), e
                                    }(o, t, i), t, i);
                                    return r && (a = xt(a, r, i)), Dn(pi(e, t.sourceId), a)
                                }
                                return e
                            }(e, n[t.sourceId], t.fetchId, t.fetchRange, t.rawEvents, o);
                        case "ADD_EVENTS":
                            return function(e, t, n, r) {
                                return n && (t = xt(t, n, r)), Dn(e, t)
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props,
                ...
                y = f.calendarOptions;
            if (m && m !== y)
                for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, l = v, u = (s = d.dateProfile) ? s.activeRange : null, si(a, ui(a, l), u, !0, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = bt(e.instances, (function(e) {
                        var i = o[e.defId];
    ...
    var ta = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                for (var t = this.props, n = this.context.theme, r = [], i = !0, a = 0, s = e; a < s.length; a++) {
                    ...
                    if ("title" === u) i = !1, r.push(wo("h2", {
                        ...
                        h && g.push(n.getClass("buttonActive")), r.push(wo("button", {
                            type: "button",
        ...
        na = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                var e, t, n = this.props,
                    ...
                    a = r.sectionWidgets,
                    s = a.center;
                return a.left ? (i = !0, e = a.left) : e = a.start, a.right ? (i = !0, t = a.right) : t = a.end, wo("div", {
        ...
        ra = function(e) {
            function t() {
                ...
                return t.state = {
                    ...
                    t.el = e, Wo(t.props.elRef, e), t.updateAvailableWidth()
            ...
            return n(t, e), t.prototype.render = function() {
                var e = this.props,
                    ...
                    o = "",
                    i = "";
                return n ? null !== t.availableWidth ? o = t.availableWidth / n : i = 1 / n * 100 + "%" : o = e.height || "", wo("div", {
        ...
        ia = function(e) {
            function t(t) {
                ...
                return a.handleEventElRemove = function(e) {
                    ...
                    $n(t) && (a.currentSegEl = t, a.triggerEvent("eventMouseEnter", e, t))
                }, a.handleSegLeave = function(e, t) {
                    a.currentSegEl && (a.currentSegEl = null, a.triggerEvent("eventMouseLeave", e, t))
                }, a.removeHoverListeners = (n = t.el, ".fc-event", r = a.handleSegEnter, o = a.handleSegLeave, Ie(n, "mouseover", ".fc-event", (function(e, t) {
                    if (t !== i) {
                        i = t, r(e, t);
                        var n = function(e) {
        ...
        aa = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildViewContext = qt(Ho), t.buildViewPropTransformers = qt(la), t.buildToolbarProps = qt(sa), t.headerRef = _o(), t.footerRef = _o(), t.interactionsStore = {}, t.state = {
                    viewLabelId: xe()
            ...
            return n(t, e), t.prototype.render = function() {
                var e, t = this.props,
                    n = t.toolbarConfig,
                    o = t.options,
                    i = this.buildToolbarProps(t.viewSpec, t.dateProfile, t.dateProfileGenerator, t.currentDate, _r(t.options.now, t.dateEnv), t.viewTitle),
                    a = !1,
                    s = "";
    ...
    var ua = function(e) {
        ...
        return n(t, e), t.prototype.render = function() {
            ...
            return $r() || i.push("fc-liquid-hack"), e.children(i, o, r, n)
        }, t.prototype.componentDidMount = function() {
    ...
    var fa = function(e) {
        ...
        ga = function(e) {
            function t(t, n) {
                ...
                return r.initialNowDate = _r(n.options.now, n.dateEnv), r.initialNowQueriedMs = (new Date).valueOf(), r.state = r.computeTiming().currentState, r
            }
            return n(t, e), t.prototype.render = function() {
                var e = this.props,
                    t = this.state;
    ...
    var ya = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.createDayHeaderFormatter = qt(Ea), t
        }
        return n(t, e), t.prototype.render = function() {
            var e = this.context,
                t = this.props,
    ...
    function wa(e, t, n) {
        ...
        for (var o in r)
            if (!qn(t.validRange, r[o].range)) return !1;
        return _a({
            eventDrag: e
        }, n)
    }
    ...
    function Ta(e, t, n, o) {
        return void 0 === n && (n = {}), !(e.eventDrag && ! function(e, t, n, o) {
            ...
            o && (c = bt(c, o));
            var d, p, f = (d = e.eventStore, p = a.affectedEvents.instances, {
                    defs: d.defs,
                ...
                h = f.defs,
                v = f.instances,
                g = Jn(h, e.eventUiBases);
            for (var m in u) {
                var y = u[m],
                    E = y.range,
                    S = c[y.defId],
                    b = l[y.defId];
                if (!ka(S.constraints, E, f, e.businessHours, t)) return !1;
                var D = t.options.eventOverlap,
                    C = "function" == typeof D ? D : null;
                for (var w in v) {
                    var R = v[w];
                    if (Gn(E, R.range)) {
                        if (!1 === g[R.defId].overlap && a.isEvent) return !1;
                        if (!1 === S.overlap) return !1;
                        if (C && !C(new kr(t, h[R.defId], R), new kr(t, b, y))) return !1
                    }
                }
                for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
                    var x, M = k[T],
                        ...
                        P = _.defs[b.defId],
                        N = _.instances[m];
                    if (x = P ? new kr(t, P, N) : new kr(t, b), !M(mr(I, t), x)) return !1
                }
            }
            return !0
            ...
            if (o && (c = o(c)), !ka(c.constraints, u, i, e.businessHours, t)) return !1;
            ...
            for (var f in s) {
                ...
                if (Gn(u, h.range)) {
                    ...
                    if (p && !p(new kr(t, a[h.defId], h), null)) return !1
                }
            }
    ...
    function ka(e, t, n, r, o) {
        for (var i = 0, a = e; i < a.length; i++)
            if (!Ia(xa(a[i], t, n, r, o), t)) return !1;
        return !0
    }
        ...
        Na = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                var e = this.props,
                    ...
                    r = t && n,
                    o = ["fc-scroller"];
                return t && (n ? o.push("fc-scroller-liquid-absolute") : o.push("fc-scroller-liquid")), wo("div", {
                    ref: this.handleEl,
                    className: o.join(" "),
                    style: {
    ...
    function Va(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++)
            for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(wo("col", {
                style: {
    ...
    var Za = function(e) {
        function t() {
            ...
            return t.processCols = qt((function(e) {
                return e
            }), Wa), t.renderMicroColGroup = qt(Va), t.scrollerRefs = new Ha, t.scrollerElRefs = new Ha(t._handleScrollerEl.bind(t)), t.state = {
                shrinkWidth: null,
                forceYScrollbars: !1,
    ...
    var ns = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.refineHookProps = Yt(ts), t.normalizeClassNames = Xo(), t
        }
        return n(t, e), t.prototype.render = function() {
            var e = this.props,
                t = this.context,
    ...
    function ps(e) {
        ...
        return {
            start: fs(n),
            end: (t = n, t.reduce(vs).eventRange.range.end)
        }
    }
    ...
    var gs = function(e) {
            ...
            return o.isRendering = !1, o.isRendered = !1, o.currentClassNames = [], o.customContentRenderId = 0, o.handleAction = function(e) {
                ...
                if (o.isRendering) {
                    ...
                    Ro(wo(ua, {
                        ...
                        return o.setClassNames(t), o.setHeight(n), wo(Go.Provider, {
                ...
                } else o.isRendered && (o.isRendered = !1, Io(o.el), o.setClassNames([]), o.setHeight(""));
                Mo()
            }, o.el = t, o.renderRunner = new wi(o.handleRenderRequest), new Ti({
                optionOverrides: n,
                calendarApi: o,
        ...
        return n(t, e), Object.defineProperty(t.prototype, "view", {
            ...
            e.prototype.updateSize.call(this), Mo()
        ...
        Ss = function() {
            function e(e) {
                ...
                this.subjectEl = null, this.selector = "", this.handleSelector = "", this.shouldIgnoreMove = !1, this.shouldWatchScroll = !0, this.isDragging = !1, this.isTouchDragging = !1, this.wasTouchScroll = !1, this.handleMouseDown = function(e) {
                    ...
                    if (t.isDragging) {
                        var n = e.target;
                        n.removeEventListener("touchmove", t.handleTouchMove), n.removeEventListener("touchend", t.handleTouchEnd), n.removeEventListener("touchcancel", t.handleTouchEnd), window.removeEventListener("scroll", t.handleTouchScroll, !0), t.emitter.trigger("pointerup", t.createEventFromTouch(e)), t.cleanup(), t.isTouchDragging = !1, ms += 1, setTimeout((function() {
                            ms -= 1
                ...
                }, this.containerEl = e, this.emitter = new mo, e.addEventListener("mousedown", this.handleMouseDown), e.addEventListener("touchstart", this.handleTouchStart, {
                    passive: !0
            ...
            return e.prototype.destroy = function() {
                ...
                Es = !1, this.isDragging = !1, this.subjectEl = null, this.destroyScrollWatch()
    ...
    var Ds = function() {
        ...
        Ts = function() {
            ...
            return e.prototype.start = function(e, t, n) {
                ...
                if (this.isEnabled) {
                    ...
                    o < 0 ? this.everMovedUp = !0 : o > 0 && (this.everMovedDown = !0), i < 0 ? this.everMovedLeft = !0 : i > 0 && (this.everMovedRight = !0), this.pointerScreenX = n, this.pointerScreenY = r, this.isAnimating || (this.isAnimating = !0, this.requestAnimation(_s()))
                }
        ...
        ks = function(e) {
            function t(t, n) {
                ...
                return o.emitter.on("pointerdown", r.onPointerDown), o.emitter.on("pointermove", r.onPointerMove), o.emitter.on("pointerup", r.onPointerUp), n && (o.selector = n), r.mirror = new Ds, r.autoScroller = new Ts, r
            }
            return n(t, e), t.prototype.destroy = function() {
        ...
        xs = function() {
            function e(e) {
                this.origRect = ho(e), this.scrollCaches = vo(e).map((function(e) {
                    return new ws(e, !0)
                }))
            }
            return e.prototype.destroy = function() {
                ...
                for (var n, r = {
                    ...
                    var a = i[o];
                    if (void 0, "HTML" !== (n = a.getEventTarget().tagName) && "BODY" !== n && !qr(r, a.clientRect)) return !1
                }
                return !0
            }, e
        }(),
        Ms = function() {
            function e(e, t) {
                ...
                }, this.droppableStore = t, e.emitter.on("pointerdown", this.handlePointerDown), e.emitter.on("dragstart", this.handleDragStart), e.emitter.on("dragmove", this.handleDragMove), e.emitter.on("pointerup", this.handlePointerUp), e.emitter.on("dragend", this.handleDragEnd), this.dragging = e, this.emitter = new mo
            }
            return e.prototype.processFirstCoord = function(e) {
                ...
                !t && Is(this.movingHit, n) || (this.movingHit = n, this.emitter.trigger("hitupdate", n, !1, e))
            }, e.prototype.prepareHits = function() {
                this.offsetTrackers = bt(this.droppableStore, (function(e) {
                    return e.component.prepareHits(), new xs(e.el)
                }))
                ...
                for (var i in n) {
                    ...
                    if (s && s.isWithinClipping(e, t)) {
                        ...
                        if (c >= 0 && c < f && d >= 0 && d < h) {
                            ...
                            v && qn(v.dateProfile.activeRange, v.dateSpan.range) && (!o || v.layer > o.layer) && (v.componentId = i, v.context = a.context, v.rect.left += l, v.rect.right += l, v.rect.top += u, v.rect.bottom += u, o = v)
                        }
                    }
                }
                return o
    ...
    var Ns = function(e) {
            function t(t) {
                ...
                }, n.dragging = new ks(t.el), n.dragging.autoScroller.isEnabled = !1;
            ...
            function t(t) {
                ...
                n.dragSelection = null, n.handlePointerDown = function(e) {
                    ...
                    if (e) {
                        ...
                        }(s, e, o.pluginHooks.dateSelectionTransformers)), i && Ra(i, e.dateProfile, o) || (a = !0, i = null)
                    }
                    i ? o.dispatch({
                        type: "SELECT_DATES",
                        selection: i
                    ...
                    n.dragSelection && (gr(n.dragSelection, e, n.component.context), n.dragSelection = null)
                };
                    ...
                    if (o.isDragging) {
                        ...
                        if (e) {
                            ...
                            i === a || d.editable && d.droppable ? (s = function(e, t, n) {
                                ...
                                return u
                            }(r, e, a.getCurrentData().pluginHooks.eventDragMutationMassagers)) && (l = Er(n, a.getCurrentData().eventUiBases, s, a), c.mutatedEvents = l, wa(c, e.dateProfile, a) || (u = !0, s = null, l = null, c.mutatedEvents = {
                                defs: {},
                                instances: {}
                            })) : a = null
                        }
                        o.displayDrag(a, c), u ? Ue() : We(), t || (i === a && Is(r, e) && (s = null), o.dragging.setMirrorNeedsRevert(!s), o.dragging.setMirrorIsVisible(!e || !Te(o.subjectEl).querySelector(".fc-event-mirror")), o.receivingContext = a, o.validMutation = s, o.mutatedRelevantEvents = l)
                    }
        ...
        As = function(e) {
            function t(t) {
                ...
                n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function(e) {
                    ...
                    n.draggingSegEl = o, n.draggingSeg = $n(o), t.calendarApi.unselect(), t.emitter.trigger("eventResizeStart", {
                        el: o,
                    ...
                    e && (e.componentId === a.componentId && n.isHitComboAllowed && !n.isHitComboAllowed(a, e) || (l = function(e, t, n, r) {
                        ...
                        return null
                    }(a, e, r.subjectEl.classList.contains("fc-event-resizer-start"), s.range))), l && (u = Er(i, o.getCurrentData().eventUiBases, l, o), d.mutatedEvents = u, wa(d, e.dateProfile, o) || (c = !0, l = null, u = null, d.mutatedEvents = null)), u ? o.dispatch({
                        type: "SET_EVENT_RESIZE",
                        state: d
                    }) : o.dispatch({
                        type: "UNSET_EVENT_RESIZE"
                    }), c ? Ue() : We(), t || (l && Is(a, e) && (l = null), n.validMutation = l, n.mutatedRelevantEvents = u)
                }, n.handleDragEnd = function(e) {
                    var t = n.component.context,
                        o = n.eventRange.def,
            ...
            function e(e) {
                ...
                this.context = e, this.isRecentPointerDateSelect = !1, this.matchesCancel = !1, this.matchesEvent = !1, this.onSelect = function(e) {
                    ...
                    var n = t.context.options.unselectCancel,
                        r = _e(e.origEvent);
                    t.matchesCancel = !!Se(r, n), t.matchesEvent = !!Se(r, Os.SELECTOR)
        ...
        Vs = function() {
            function e(e, t) {
                ...
                this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function(e) {
                    ...
                    }(e.dateSpan, n.dragMeta, a), u.mutatedEvents = Sn(s), (l = !wa(u, e.dateProfile, a)) && (u.mutatedEvents = {
                        defs: {},
                        instances: {}
    ...
    var Fs = function() {
            function e(e, t) {
                ...
                r.touchScrollAllowed = !1, null != t.itemSelector && (r.pointer.selector = t.itemSelector), null != t.appendTo && (r.mirror.parentNode = t.appendTo), r.emitter.on("pointerdown", this.handlePointerDown), r.emitter.on("dragstart", this.handleDragStart), new Vs(r, t.eventData)
            }
            return e.prototype.destroy = function() {
                this.dragging.destroy()
            }, e
        ...
        zs = function() {
            function e(e, t) {
                ...
                "string" == typeof t.itemSelector ? r.pointer.selector = t.itemSelector : n === document && (r.pointer.selector = "[data-event]"), "string" == typeof t.mirrorSelector && (r.mirrorSelector = t.mirrorSelector), new Vs(r, t.eventData)
            }
            return e.prototype.destroy = function() {
                this.dragging.destroy()
            }, e
    ...
    var ol = ln({
        ...
        il = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.rootElRef = _o(), t.state = {
                    dayNumberId: xe()
                }, t.handleRootEl = function(e) {
                    Wo(t.rootElRef, e), Wo(t.props.elRef, e)
                }, t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
    ...
    var sl = function(e) {
        ...
        ll = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.cellElRefs = new Ha, t.frameElRefs = new Ha, t.fgElRefs = new Ha, t.segHarnessRefs = new Ha, t.rootElRef = _o(), t.state = {
                    framePositions: null,
                    ...
                    c = function(e, t, n, r, o, i, a) {
                        ...
                        for (var D = 0, C = p; D < C.length; D++) {
                            ...
                            for (v[_.start].push({
                                    ...
                                    absoluteTop: 0,
                                    marginTop: 0
                                }), b = _.start; b < _.end; b += 1) m[b] += 1, h[b].push({
                                seg: al(R, b, b + 1, a),
                                isVisible: !1,
                                isAbsolute: !1,
                                absoluteTop: 0,
                ...
                if (c)
                    for (var h = 0, v = t; h < v.length; h++) {
                        var g = v[h],
                            ...
                            D = "",
                            C = "";
                        b && (l.isRtl ? (C = 0, D = c.lefts[m.lastCol] - c.lefts[m.firstCol]) : (D = 0, C = c.rights[m.firstCol] - c.rights[m.lastCol])), f.push(wo("div", {
    ...
    var ul = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitBusinessHourSegs = qt(qs), t.splitBgEventSegs = qt(qs), t.splitFgEventSegs = qt(qs), t.splitDateSelectionSegs = qt(qs), t.splitEventDrag = qt(Zs), t.splitEventResize = qt(Zs), t.rowRefs = new Ha, t.handleRootEl = function(e) {
                t.rootEl = e, e ? t.context.registerInteractiveComponent(t, {
                    el: e,
        ...
        return n(t, e), t.prototype.render = function() {
            var e = this,
                ...
                f = !0 === o || !0 === r;
            return f && !i && (f = !1, r = null, o = null), wo("div", {
            ...
            })), !1, !0), this.colPositions = new yo(this.rootEl, this.rowRefs.currentMap[0].getCellEls(), !0, !1)
    ...
    var dl = function(e) {
        ...
        pl = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.slicer = new dl, t.tableRef = _o(), t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this.props,
                    t = this.context;
        ...
        fl = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildDayTableModel = qt(hl), t.headerRef = _o(), t.tableRef = _o(), t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    t = this.context,
                    ...
                    dateProfileGeneratorClass: function(e) {
                        ...
                        return n(t, e), t.prototype.buildRenderRange = function(t, n, r) {
                            var o, i = this.props.dateEnv,
                                ...
                                s = a.start,
                                l = a.end;
                            return /^(year|month)$/.test(n) && (s = i.startOfWeek(s), (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = et(o, 1))), this.props.monthMode && this.props.fixedWeekCount && (l = et(l, 6 - Math.ceil(rt(s, l)))), {
                                start: s,
                                end: l
                            }
                        }, t
    ...
    var Sl = function(e) {
        ...
        Dl = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.allDaySplitter = new gl, t.headerElRef = _o(), t.rootElRef = _o(), t.scrollerElRef = _o(), t.state = {
                    slatCoords: null
    ...
    var wl = function() {
        ...
        _l = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.rootElRef = _o(), t.slatElRefs = new Ha, t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this.props,
                    t = this.context;
                ...
                var e, t = this.context,
                    n = this.props;
                n.onCoords && null !== n.clientWidth && this.rootElRef.current.offsetHeight && n.onCoords(new wl(new yo(this.rootElRef.current, (e = this.slatElRefs.currentMap, n.slatMetas.map((function(t) {
                    return e[t.key]
    ...
    function Il(e, t, n) {
        ...
        return i = l, 1, a = Ol((function(e, t, n) {
            return Fi(e)
        }), (function(e, t, n) {
    ...
    var Ll = ln({
        ...
        Ul = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                return this.props.isShort && e.push("fc-timegrid-event-short"), wo(Ka, r({}, this.props, {
        ...
        Vl = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.sortEventSegs = qt(er), t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    t = this.props,
    ...
    var zl = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.splitFgEventSegs = qt(Tl), t.splitBgEventSegs = qt(Tl), t.splitBusinessHourSegs = qt(Tl), t.splitNowIndicatorSegs = qt(Tl), t.splitDateSelectionSegs = qt(Tl), t.splitEventDrag = qt(kl), t.splitEventResize = qt(kl), t.rootElRef = _o(), t.cellElRefs = new Ha, t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    t = this.props,
                ...
                var e, t = this.props;
                t.onColCoords && null !== t.clientWidth && t.onColCoords(new yo(this.rootElRef.current, (e = this.cellElRefs.currentMap, t.cells.map((function(t) {
                    return e[t.key]
                }))), !0, !1))
            }, t
        }(Ao),
        jl = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.processSlotOptions = qt(Gl), t.state = {
                    slatCoords: null
                }, t.handleRootEl = function(e) {
    ...
    var ql = function(e) {
        ...
        Yl = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildDayRanges = qt(Zl), t.slicer = new ql, t.timeColsRef = _o(), t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    t = this.props,
    ...
    function Kl(e, t, n, r, o) {
        for (var i = new Date(0), a = e, s = Nt(0), l = n || function(e) {
                ...
                for (t = Xl.length - 1; t >= 0; t -= 1)
                    if (null !== (r = Wt(n = Nt(Xl[t]), e)) && r > 1) return n;
                return e
            }(r), u = []; Ut(a) < Ut(t);) {
            var c = o.add(i, a),
                d = null !== Wt(s, l);
    ...
    var $l = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildTimeColsModel = qt(Jl), t.buildSlatMetas = qt(Kl), t
        }
        return n(t, e), t.prototype.render = function() {
            var e = this,
                t = this.context,
                    ...
                    return wo("tr", {
                        ...
                        if (!1 !== i.displayEventTime) {
                            var a = e.eventRange.def,
                                ...
                                l = !1,
                                u = void 0;
                            if (a.allDay ? l = !0 : Wn(e.eventRange.range) ? e.isStart ? u = ir(e, t, n, null, null, s.range.start, e.end) : e.isEnd ? u = ir(e, t, n, null, null, e.start, s.range.end) : l = !0 : u = ir(e, t, n), l) {
                                var c = {
    ...
    var iu = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.computeDateVars = qt(su), t.eventStoreToSegs = qt(t._eventStoreToSegs), t.state = {
                timeHeaderId: xe(),
                eventHeaderId: xe(),
                dateHeaderIdRoot: xe()
                ...
                fetch: function(e, t, n) {
                    ...
                    if (l) {
                        var u = function(e) {
                                ...
                                return t || (t = "https://www.googleapis.com/calendar/v3/calendars"), t + "/" + encodeURIComponent(e.googleCalendarId) + "/events"
                            }(s),
                            c = s.extraParams,
                            d = "function" == typeof c ? c() : c,
                            p = function(e, t, n, o) {
                                var i, a, s;
                                return o.canComputeOffset ? (a = o.formatIso(e.start), s = o.formatIso(e.end)) : (a = tt(e.start, -1).toISOString(), s = tt(e.end, 1).toISOString()), i = r(r({}, n || {}), {
                                    key: t,
                                    timeMin: a,
                                    timeMax: s,
                                    singleEvents: !0,
                                    maxResults: 9999
                                }), "local" !== o.timeZone && (i.timeZone = o.timeZone), i
                            }(e.range, l, d, i);
    ...
    return Ci.push(js, vl, Ql, uu, du, pu), e.BASE_OPTION_DEFAULTS = cn, e.BASE_OPTION_REFINERS = un, e.BaseComponent = Ao, e.BgEvent = os, e.BootstrapTheme = cu, e.Calendar = gs, e.CalendarApi = Tr, e.CalendarContent = aa, e.CalendarDataManager = Ti, e.CalendarDataProvider = Ui, e.CalendarRoot = ua, e.Component = Co, e.ContentHook = qo, e.CustomContentRenderContext = Go, e.DateComponent = Vo, e.DateEnv = Or, e.DateProfileGenerator = ri, e.DayCellContent = es, e.DayCellRoot = ns, e.DayGridView = fl, e.DayHeader = ya, e.DaySeriesModel = Sa, e.DayTable = pl, e.DayTableModel = ba, e.DayTableSlicer = dl, e.DayTimeCols = Yl, e.DayTimeColsSlicer = ql, e.DayTimeColsView = $l, e.DelayedRunner = wi, e.Draggable = Fs, e.ElementDragging = $i, e.ElementScrollController = So, e.Emitter = mo, e.EventApi = kr, e.EventRoot = Xa, e.EventSourceApi = ye, e.FeaturefulElementDragging = ks, e.Fragment = To, e.Interaction = Yi, e.ListView = iu, e.MoreLinkRoot = cs, e.MountHook = Zo, e.NamedTimeZoneImpl = function(e) {
        this.timeZoneName = e
    }, e.NowIndicatorRoot = Ja, e.NowTimer = ga, e.PointerDragging = Ss, e.PositionCache = yo, e.RefMap = Ha, e.RenderHook = jo, e.ScrollController = Eo, e.ScrollResponder = Po, e.Scroller = Na, e.SegHierarchy = Wi, e.SimpleScrollGrid = Za, e.Slicer = Da, e.Splitter = Qr, e.StandardEvent = Ka, e.Table = ul, e.TableDateCell = fa, e.TableDowCell = va, e.TableView = Gs, e.Theme = Do, e.ThirdPartyDraggable = zs, e.TimeCols = jl, e.TimeColsSlatsCoords = wl, e.TimeColsView = Dl, e.ViewApi = Dr, e.ViewContextType = No, e.ViewRoot = Jo, e.WeekNumberRoot = as, e.WindowScrollController = bo, e.addDays = tt, e.addDurations = Ot, e.addMs = nt, e.addWeeks = et, e.allowContextMenu = ze, e.allowSelection = Fe, e.applyMutationToEventStore = Er, e.applyStyle = we, e.applyStyleProp = Re, e.asCleanDays = function(e) {
        return e.years || e.months || e.milliseconds ? 0 : e.days
    }, e.asRoughMinutes = function(e) {
        return Ut(e) / 6e4
    }, e.asRoughMs = Ut, e.asRoughSeconds = function(e) {
        return Ut(e) / 1e3
    }, e.binarySearch = qi, e.buildClassNameNormalizer = Xo, e.buildDayRanges = Zl, e.buildDayTableModel = hl, e.buildEntryKey = Fi, e.buildEventApis = Mr, e.buildEventRangeKey = lr, e.buildHashFromArray = function(e, t) {
        for (var n = {}, r = 0; r < e.length; r += 1) {
            var o = t(e[r], r);
            n[o[0]] = o[1]
        }
        return n
    }, e.buildIsoString = Ft, e.buildNavLinkAttrs = io, e.buildSegCompareObj = tr, e.buildSegTimeText = ir, e.buildSlatMetas = Kl, e.buildTimeColsModel = Jl, e.collectFromHash = kt, e.combineEventUis = kn, e.compareByFieldSpec = qe, e.compareByFieldSpecs = Ge, e.compareNumbers = Ke, e.compareObjs = _t, e.computeEarliestSegStart = fs, e.computeEdges = po, e.computeFallbackHeaderFormat = ca, e.computeHeightAndMargins = function(e) {
        return e.getBoundingClientRect().height + function(e) {
            var t = window.getComputedStyle(e);
            return parseInt(t.marginTop, 10) + parseInt(t.marginBottom, 10)
        }(e)
    }, e.computeInnerRect = fo, e.computeRect = ho, e.computeSegDraggable = nr, e.computeSegEndResizable = or, e.computeSegStartResizable = rr, e.computeShrinkWidth = Oa, e.computeSmallestCellWidth = Je, e.computeVisibleDayRange = Un, e.config = Ji, e.constrainPoint = Zr, e.createAriaClickAttrs = He, e.createContext = ko, e.createDuration = Nt, e.createElement = wo, e.createEmptyEventStore = function() {
        return {
            defs: {},
            instances: {}
        }
    }, e.createEventInstance = mt, e.createEventUi = Tn, e.createFormatter = ln, e.createPlugin = Fo, e.createPortal = xo, e.createRef = _o, e.diffDates = Vn, e.diffDayAndTime = it, e.diffDays = ot, e.diffPoints = Kr, e.diffWeeks = rt, e.diffWholeDays = st, e.diffWholeWeeks = at, e.disableCursor = Ue, e.elementClosest = Se, e.elementMatches = be, e.enableCursor = We, e.eventTupleToStore = Sn, e.filterEventStoreDefs = Cn, e.filterHash = St, e.findDirectChildren = function(e, t) {
        for (var n = e instanceof HTMLElement ? [e] : e, r = [], o = 0; o < n.length; o += 1)
        ...
        return r
    }, e.findElements = De, e.flexibleCompare = Ye, e.flushToDom = Mo, e.formatDate = function(e, t) {
        void 0 === t && (t = {});
        var n = Br(t),
            r = ln(t),
    ...
    }, e.getAllowYScrolling = La, e.getCanVGrowWithinCell = $r, e.getClippingParents = vo, e.getDateMeta = to, e.getDayClassNames = no, e.getDefaultEventEnd = yr, e.getElRoot = Te, e.getElSeg = $n, e.getEntrySpanEnd = Vi, e.getEventClassNames = sr, e.getEventTargetViaRoot = _e, e.getIsRtlScrollbarOnLeft = lo, e.getRectCenter = Xr, e.getRelevantEvents = bn, e.getScrollGridClassNames = za, e.getScrollbarWidths = uo, e.getSectionClassNames = ja, e.getSectionHasLiquidHeight = Aa, e.getSegAnchorAttrs = ur, e.getSegMeta = ar, e.getSlotClassNames = function(e, t) {
    ...
    }, e.getStickyFooterScrollbar = Ya, e.getStickyHeaderDates = qa, e.getUnequalProps = Rt, e.getUniqueDomId = xe, e.globalLocales = Ar, e.globalPlugins = Ci, e.greatestDurationDenominator = Vt, e.groupIntersectingEntries = Bi, e.guid = Le, e.hasBgRendering = Xn, e.hasShrinkWidth = Ba, e.identity = yn, e.interactionSettingsStore = Ki, e.interactionSettingsToStore = Xi, e.intersectRanges = zn, e.intersectRects = Yr, e.intersectSpans = ji, e.isArraysEqual = Gt, e.isColPropsEqual = Wa, e.isDateSelectionValid = Ra, e.isDateSpansEqual = pr, e.isInt = $e, e.isInteractionValid = wa, e.isMultiDayRange = Wn, e.isPropsEqual = wt, e.isPropsValid = Ta, e.isValidDate = vt, e.joinSpans = zi, e.listenBySelector = Ie, e.mapHash = bt, e.memoize = qt, e.memoizeArraylike = function(e, t, n) {
        var r = this,
            o = [],
            i = [];
        return function(a) {
    ...
    }, e.memoizeObjArg = Yt, e.mergeEventStores = Dn, e.multiplyDuration = At, e.padStart = Ze, e.parseBusinessHours = Gr, e.parseClassNames = wn, e.parseDragMeta = ea, e.parseEventDef = An, e.parseFieldSpecs = je, e.parseMarker = Hr, e.pointInsideRect = qr, e.preventContextMenu = Be, e.preventDefault = Me, e.preventSelection = Ve, e.rangeContainsMarker = Yn, e.rangeContainsRange = qn, e.rangesEqual = jn, e.rangesIntersect = Gn, e.refineEventDef = Hn, e.refineProps = mn, e.removeElement = Ee, e.removeExact = function(e, t) {
        for (var n = 0, r = 0; r < e.length;) e[r] === t ? (e.splice(r, 1), n += 1) : r += 1;
        return n
    }, e.render = Ro, e.renderChunkContent = Ua, e.renderFill = rs, e.renderMicroColGroup = Va, e.renderScrollShim = Ga, e.requestJson = Si, e.sanitizeShrinkWidth = Fa, e.setElSeg = Kn, e.setRef = Wo, e.sliceEventStore = Zn, e.sliceEvents = function(e, t) {
        return Zn(e.eventStore, e.eventUiBases, e.dateProfile.activeRange, t ? e.nextDayThreshold : null).fg
    }, e.sortEventSegs = er, e.startOfDay = lt, e.translateRect = function(e, t, n) {
        return {
            left: e.left + t,
            right: e.right + t,
            top: e.top + n,
    ...
    }, e.triggerDateSelect = gr, e.unmountComponentAtNode = Io, e.unpromisify = go, e.version = "5.10.1", e.whenTransitionDone = Ne, e.wholeDivideDurations = Wt, Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});