                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    {{-- <a href="#"><img style="height: 40px" src="{{ asset('images/FMDQlogo.svg')}}" alt="logo"></a> --}}
                        ...
                        <tbody>
                             <tr>
                                <td style="padding: 30px 30px 15px 30px;">
                                    {{-- <h2 style="font-size: 18px; color: #ad8e4f; font-weight: 600; margin: 0;">Confirm Your E-Mail Address</h2> --}}
                                </td>
                            </tr> 
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px;">Dear {{$user->name}},</p>
                                    <p style="margin-bottom: 10px;">Thank you for registering on the FMDQ 
                                        Financial Markets Regulations & Rules Repository Portal. Please click on the link below to verify your email address and activate your account.</p>
                                  
                                    <a href="{{ url('/user/verify/' .$user->verifyUser->token) }}" style="background-color:#ad8e4f;border-radius:4px;color:#ffffff;display:inline-block;font-size:13px;font-weight:600;line-height:44px;text-align:center;text-decoration:none;text-transform: uppercase; padding: 0 30px">Verify Email</a>
                                </td>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © <?php echo date('Y') ?> FMDQ Group. All rights reserved.</p>
                                    ...
                                    <p style="padding-top: 15px; font-size: 12px;">This email was sent to you as a registered user of <a style="color: #6576ff; text-decoration:none;" href="">FMDQ Participant Onboarding Portal</a>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table> --}}
