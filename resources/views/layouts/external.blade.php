...
<body>
    ...
    <footer class="footer">
        ...
        <div class="arr">
            <p>Powered by iQx Consult Limited</p>
            <p>Copyright © FMDQ Group PLC. All rights reserved.</p>
        </div>
    </footer>
        ...
        ! function(NioApp, $) {
            ...
            NioApp.Calendar = function() {
                            ...
                            .then(events => {
                                ...
                                `;
                                    ...
                                    return {
                                        ...
                                        // end: addExtraDayToDate(event .end_date), 
                                        ...
                                        new_date: formatDate(event.start_date),
                ...
                function setModalContent(event) {
                    ...
                    $('#preview-event-start').text(event.extendedProps.new_date);
                    ...
                    // Additional formatting for start and end times, etc., if needed
                ...
                function createGoogleCalendarUrl(event) {
                    ...
                    const baseUrl = 'https://outlook.office365.com/calendar/0/action/compose?';
                   // https://outlook.office365.com/calendar/view/workweek
                    const params = new URLSearchParams({
                        subject: event.event_title_code || '',
                        body: event.event_description || '',
                        location: event.venue || '',
                        startdt: formatDateTimeISO(event.start_date, event.start_time),
                        enddt: formatDateTimeISO(event.end_date, event.end_time),
                    });
