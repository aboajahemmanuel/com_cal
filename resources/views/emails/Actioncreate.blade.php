                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;"> Please be advised that a new {{ $title }}
                                        ({{ $action }})
                                        has been created and is awaiting your review and approval.</p>

                                    <p style="margin-bottom: 10px;">Kindly <a href="{{ url('login') }}">login</a> to
                                        view details</p>
