                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Your account has been successfully created on
                                        Compliance Calendar for FMDQ Private Markets Limited</p>
                                    <p style="margin-bottom: 10px;">Please find below details for your account.</p>


                                    <p style="color: black;"><b>Link : <a
                                                href="{{ url('login') }}">https://comcal.fmdqgroup.com</a> </b></p>

                                    <p style="color: black;"><b> Email : {{ $email }} </b></p>

                                    <p style="color: black;"><b> Password : {{ $password }} </b></p>

                                    <p style="color: black;"><b> Date Created : <?php echo date('d-m-Y  H:i:s', strtotime($created_at)); ?></b></p>
