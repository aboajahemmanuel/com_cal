...
class PaymentController extends Controller
{
    ...
    public function paystore(Request $request)
    {
        ...
        $PaymentParam = '{"em":"' . $email . '","fn":"' . $name . '","ln":"' . $name . '","am":"' . $amount . '","pn":"' . $phone . '","scode":"0301333333"}';
    ...
    public function payment_success()
    {
        ...
        $doc_payment =  Transaction::where('user_id', $user_id)->orderBy('created_at', 'desc')->first();

        $reference =   $doc_payment->reference;

        $userpayment =  Transaction::where('user_id', $user_id)->where('reference', $reference)->orderBy('created_at', 'desc')->first();
        ...
        $doc_details =   Regulation::where('id', $userpayment->regulation_id)->first();
