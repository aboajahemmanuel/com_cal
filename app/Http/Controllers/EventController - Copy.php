...
class EventController extends Controller
{
    ...
    public function addevent(Request $request)
    {
        $request->validate([
            ...
            'event_title_code.required' => 'The event title code is required.',
            ...
            'issuer_description.required' => 'The issuer description is required.',
            'category_id.required' => 'The category ID is required.',
            'category_name.required' => 'The category name is required.',
            'category_color.required' => 'The category color is required.',
            'event_image.required' => 'The event image is required.',
            'event_image.mimes' => 'The event image must be a file of type: jpeg, png.',
        ]);
